...
var META_SAL = ['getAttr', 'getAttrs', 'getManifest', 'setAttr', 'setAttrs', 'getData', 'setData', 'getJSON', 'on', 'off', 'trigger'];
  ...
  */
		...
		value: function renderWrapper() {
			if (this.getWorking('wrapper')) {
				...
				var wrapper = new notFramework.notComponent(input);
		...
		value: function addFieldComponent(fieldName, value) {
